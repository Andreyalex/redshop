...
$_['error_warning']             = 'Пожалуйста, проверьте введенные данные!';
...
$_['entry_meta_title'] = 'Название SEO';
$_['entry_product_limit'] = 'Количество единиц на странице(Каталог)';
$_['entry_product_description_length'] = 'Лимит описания списка(Каталог)';
$_['entry_limit_admin'] = 'оличество единиц на странице(Админ)';
$_['entry_review_guest'] = 'Разрешить обзоры от Гостя';
$_['entry_review_mail'] = 'Отсылать письмо при новом обзоре';
$_['entry_checkout_guest'] = 'Заказ Гостя';
$_['entry_order_mail'] = 'Отсылать письмо при новом заказе';
$_['entry_mail_alert'] = 'Дополнительные сообщения E-mail';
$_['entry_affiliate_approval'] = 'Аффилиат требует подтверждения';
$_['entry_affiliate_auto'] = 'Автоматическая комиссия';
$_['entry_affiliate_commission'] = 'Комиссия аффилиата (%)';
$_['entry_affiliate_mail'] = 'Оповещение письмом о новом аффилиате';
...
$_['help_currency'] = 'Изменить валюту по-умолчанию. Почистите кеш браузера.';