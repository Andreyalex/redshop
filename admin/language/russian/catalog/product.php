...
$_['help_upc'] = 'Глобальный код продукта';
...
$_['help_minimum'] = 'Минимальное количество заказа';
$_['help_stock_status'] = 'Статус когда продукта нет на складе';
...
$_['help_tag'] = 'разделенный запятыми';
