<?php
class ControllerShippingNewpost extends Controller {
	private $error = array(); 
	...
	public function index() {   
 		...
 		if (isset($this->error['warning'])) {
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('shipping/newpost', 'token=' . $this->session->data['token'], 'SSL')
   		);
		
		$data['action'] = $this->url->link('shipping/newpost', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('shipping/newpost.tpl', $data));
	}
	
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'shipping/newpost')) {
