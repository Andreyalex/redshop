...
function addModule() {	
	...
	html += '  <td class="text-left"><input type="text" name="bestseller_module[' + module_row + '][image_width]" value="200"  class="form-control" /> <input type="text" name="bestseller_module[' + module_row + '][image_height]" value="200"  class="form-control" /></td>';
