  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="row" style="text-align: right;">
        <div class="col-sm-1 col-sm-offset-2 text-right" style="display:inline-block; float:none;">
          <label class="control-label" for="input-sort"><?php echo $text_sort; ?></label>
        </div>
        <div class="col-sm-2 text-right" style="display:inline-block; float:none;">
        ...
        <div class="col-sm-1 text-right" style="display:inline-block; float:none;">
